 ...
 */
export const DEFAULT_CALLBACK_GAS_LIMIT = 200_000;

export function resolveCallbackGasLimit(gasLimit?: number): number {
  return gasLimit === undefined ? DEFAULT_CALLBACK_GAS_LIMIT : gasLimit;
}
